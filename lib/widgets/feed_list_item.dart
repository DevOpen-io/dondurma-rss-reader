            ...
            child: Transform.translate(
              ...
              child: Card(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(16),
                  onTap: () {
                    context.read<FeedProvider>().markAsRead(widget.item.id);
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ArticleScreen(item: widget.item),
                      ),
                    );
                  },
                  child: Padding(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: widget.item.isRead
                                ? widget.item.iconBackgroundColor.withValues(
                                    alpha: 0.1,
                                  )
                            ...
                            child: widget.item.imageUrl != null
                                ...
                                : Center(
                                    child: Icon(
                                      widget.item.siteIcon,
                                      color: widget.item.isRead
                                          ? widget.item.iconColor.withValues(
                                              alpha: 0.5,
                                            )
                                          : widget.item.iconColor,
                                      size: 24,
                        ...
                        Column(
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                context.read<FeedProvider>().toggleBookmark(
                                  widget.item.id,
                                );
                              },
                              icon: Icon(
                                ...
                                color: widget.item.isBookmarked
                                    ...
                                    : Colors.grey.withValues(
                                        alpha: widget.item.isRead ? 0.5 : 1.0,
                                      ),
                                size: 22,
                              ),
                              ...
                              Padding(
                                ...
                                child: Icon(
                                  ...
                                  color: Theme.of(context).colorScheme.secondary
                                      .withValues(
                                        alpha: widget.item.isRead ? 0.4 : 0.8,
                                      ),
                                  size: 16,
                                ),
                              ),
