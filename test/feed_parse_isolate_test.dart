...
void main() {
  group('FeedService.parseFeedBody (runs in isolate via compute)', () {
    test(
      'parses RSS body, decodes entities, extracts image and date',
      () async {
    ...
    test('stable RSS GUID survives title and content updates', () {
      const first = '''<rss version="2.0"><channel><title>S</title><item>
<guid> stable-guid </guid><title>Old</title><description>One</description>
<pubDate>Thu, 02 Jul 2026 12:00:00 GMT</pubDate></item></channel></rss>''';
      const second = '''<rss version="2.0"><channel><title>S</title><item>
<guid> stable-guid </guid><title>New</title><description>Two</description>
<pubDate>Thu, 02 Jul 2026 12:00:00 GMT</pubDate></item></channel></rss>''';

      final a = FeedService.parseFeedBody((
        bodyBytes: utf8.encode(first),
        category: 'C',
        url: 'https://feed',
      ));
      final b = FeedService.parseFeedBody((
        bodyBytes: utf8.encode(second),
        category: 'C',
        url: 'https://feed',
      ));

      expect(a.single.id, 'stable-guid');
      expect(b.single.id, a.single.id);
    });

    test('stable Atom ID survives title and content updates', () {
      const first =
          '''<feed xmlns="http://www.w3.org/2005/Atom"><title>S</title>
<entry><id> atom-id </id><title>Old</title><summary>One</summary>
<updated>2026-07-02T09:30:00Z</updated></entry></feed>''';
      const second =
          '''<feed xmlns="http://www.w3.org/2005/Atom"><title>S</title>
<entry><id> atom-id </id><title>New</title><summary>Two</summary>
<updated>2026-07-02T09:30:00Z</updated></entry></feed>''';
